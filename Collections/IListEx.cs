...
namespace Utilities.DotNet.Collections
{
    ...
    public interface IListEx : IList, ICollectionEx
    {
        ...
        /// </exception>
        new int Add( object? item ); // Needed to disambiguate between IList<> and ICollectionEx<> and avoid error CS0121
        ...
        /// Thrown when <paramref name="index"/> is less than 0 or greater than <see cref="ICollection.Count">Count</see>.
        /// </exception>
        ...
        /// <inheritdoc cref="ICollectionEx.Remove(object)"/>
        new bool Remove( object? item ); // Needed to disambiguate between IList<> and ICollectionEx<> and avoid error CS0121
        ...
        /// <exception cref="ArgumentOutOfRangeException">
        /// Thrown when <paramref name="newIndex"/> is less than 0 or greater than <see cref="ICollection.Count"/>.
        /// </exception>
        ...
        /// <exception cref="ArgumentOutOfRangeException">
        /// Thrown when <paramref name="index"/> is less than 0 or greater than <see cref="ICollection.Count"/>.
        /// </exception>
        /// <exception cref="ArgumentException">
        ...
        /// </exception>
        void Replace( int index, object? newItem );

        /// <inheritdoc cref="ICollectionEx.Clear"/>
        new void Clear(); // Needed to disambiguate between IList<> and ICollectionEx<> and avoid error CS0121
        ...
        /// <inheritdoc cref="ICollectionEx.Contains(object)"/>
        new bool Contains( object? item ); // Needed to disambiguate between IList<> and ICollectionEx<> and avoid error CS0121
