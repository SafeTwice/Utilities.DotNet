...
namespace Utilities.DotNet.Test.Collections.Observables
{
    public class ObservableSortedCollectionTest
    {
        ...
        public void ICollectionEx_AddRange_InvalidObject()
        {
            ...
            Assert.False( result );
            Assert.Equal( new[] { 22, 33 }, observableCollection );
        ...
        public void ICollectionEx_RemoveRange()
        {
            ...
            Assert.Equal( NotifyCollectionChangedAction.Remove, events[ 1 ].Action );
            Assert.Equal( new[] { 8 }, events[ 1 ].OldItems );
            Assert.Null( events[ 1 ].NewItems );
            Assert.Equal( -1, events[ 1 ].OldStartingIndex );
            Assert.Equal( -1, events[ 1 ].NewStartingIndex );
#endif
        ...
        public void Replace()
        {
            ...
            IObservableCollection<double> observableCollection = new ObservableSortedCollection<double>( new[] { 5.1, 8.0, 2.9 } );
            ...
            Assert.Equal( new[] { 2.9, 5.1, 8.0 }, observableCollection );
            ...
            Assert.True( result );
            Assert.Equal( new[] { 2.9, 3.5, 5.1 }, observableCollection );
        ...
        public void Replace_Same()
        {
            ...
            var result = observableCollection.Replace( 8.0, 8.0 );
